...
typedef NS_ENUM(NSUInteger, NeoVimAutoCommandEvent) {
  ...
  NeoVimAutoCommandEventDIRCHANGED = 28,
  ...
  NeoVimAutoCommandEventWINNEW = 90,
  NeoVimAutoCommandEventWINENTER = 91,
  NeoVimAutoCommandEventWINLEAVE = 92,
};

#define NumberOfAutoCommandEvents 93
